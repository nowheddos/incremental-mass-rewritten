const RANKS = {
    ...
    desc: {
        rank: {
            ...
            '2': "unlock mass upgrade 2, mass upgrade 1 cost scaled down by 20%.",
            '3': "unlock mass upgrade 3, mass upgrade 2 cost scaled down by 20%, mass upgrade 1 boosts itself.",
            '4': "mass upgrade 3 cost scaled down by 20%.",
            ...
            '220': "rank 40 reward is powered up.",
        ...
        tier: {
            ...
            '2': "raise mass gain to the power of 1.15",
            '3': "all mass upgrades cost scaled down by 20%.",
            '4': "adds +5% tickspeed power for every tier you have, softcaps at +40%.",
            '6': "make rage powers boosted by tiers.",
            '8': "boost tier 6's reward based on dark matter.",
            '12': "make tier 4's reward effect twice as effective and remove softcap.",
            '30': "stronger effect's softcap is 10% weaker.",
            '55': "make rank 380's effect stronger based on tier.",
            '100': "Super Tetr scales 5 later.",
        },
        tetr: {
            '1': "reduce tier reqirements by 25%, Hyper Rank scaling is 15% weaker.",
            '2': "mass upgrade 3 boosts itself.",
            '3': "raise tickspeed effect by 1.05.",
            '4': "Super Rank scales weaker based on Tier, Super Tier scale is 20% weaker.",
            '5': "Hyper/Ultra Tickspeed starts later based on tetr.",
            '8': "Mass gain squared softcap starts ^1.5 later.",
        },
        pent: {
            '1': "reduce tetr reqirements by 15%, make Meta-Rank starts 1.1x later.",
            '2': "make tetr boost all radiations gain.",
        },
    },
    effect: {
        rank: {
